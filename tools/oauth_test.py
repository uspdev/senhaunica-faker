...
# request_token
request_token_url = baseurl+"/wsusuario/oauth/request_token"
...
# authorize
base_authorization_url = baseurl+"/wsusuario/oauth/authorize"
...
# access_token
access_token_url = baseurl+"/wsusuario/oauth/access_token"
...
# usuariousp
url = baseurl+"/wsusuario/oauth/usuariousp"
oauth = OAuth1Session(client_key,
                      client_secret=client_secret,
                      resource_owner_key=resource_owner_key,
                      resource_owner_secret=resource_owner_secret)
